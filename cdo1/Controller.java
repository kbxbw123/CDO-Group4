    ...
    { BufferedReader br = null;
      ...
      { String line1;
        ...
        { int i2 = right.indexOf(".");
          ...
          // if there is no . in the right side --> "c : CDO" or "s3 : Sector"
          if (i2 == -1)
          { Class cl;
            ...
            //controller get a method with --> addCDO or addSector
          ...
          //if there is a . in the right side --> "s1 : c.sectors"
          else
          {   
        ...
        //n,p,q,l,name for sectors --> "s7.p = 0.017"
        else if ("=".equals(op))
        { 
          int i1 = left.indexOf(".");
          if (i1 == -1) 
